...
import "./API3WrapperV1_1.sol";
import "./ThresholdingUtils.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract API3WrapperWithThresholdingV1_1 is API3WrapperV1_1, ThresholdingUtils {
    /* State */
    ...
    constructor(address baseCurrency, uint256 _baseCurrencyUnit) API3WrapperV1_1(baseCurrency, _baseCurrencyUnit) {}
