...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (manualActions.length > 0) {
    console.log("\n⚠️  Manual actions required to finalize dUSD AMO V2 configuration:");
...
func.id = "configure_amo_v2_dusd";
func.tags = ["dusd", "amo-v2"];
func.dependencies = ["deploy_amo_v2_dusd", DUSD_HARD_PEG_ORACLE_WRAPPER_ID];
