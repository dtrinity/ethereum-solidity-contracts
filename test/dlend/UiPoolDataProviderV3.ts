...
describe("dLEND UiPoolDataProviderV3", () => {
  ...
  beforeEach(async () => {
    ...
    const { contract: wETHToken } = await getTokenContractForSymbol(hre, deployer, "WETH");
    ...
    uiPoolDataProvider = await UiPoolDataProviderV3Factory.deploy(priceOracleAddress, await wETHToken.getAddress());
