...
export const ETH_FRXETH_FUNDAMENTAL_ORACLE_WRAPPER_ID = "ETH_FrxEthFundamentalOracleWrapper";
export const ETH_FRXETH_FUNDAMENTAL_ORACLE_WRAPPER_ID = "ETH_FrxEthFundamentalOracleWrapper";

// dUSD
export const DUSD_TOKEN_ID = "dUSD";
export const DUSD_ISSUER_CONTRACT_ID = "dUSD_Issuer";
export const DUSD_ISSUER_V2_CONTRACT_ID = "dUSD_IssuerV2_2";
...
export const DETH_ISSUER_V2_CONTRACT_ID = "dETH_IssuerV2_2";
